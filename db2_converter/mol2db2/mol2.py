...
#Ryan G. Coleman
#mol2 reader/writer
# copied from DOCK3.8@mol2db2_py3
...
import collections
import operator
from db2_converter.mol2db2 import sybyl2dock
from db2_converter.mol2db2 import atom_color_table
from db2_converter.mol2db2 import floydwarshall  # all pairs shortest paths routine
from db2_converter.mol2db2 import shortestpaths  # from one point to all others
...
def append_mol2(molecule,filename):
  write_mol2(molecule,filename,"a")
